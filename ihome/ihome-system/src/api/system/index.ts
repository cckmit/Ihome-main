/* eslint-disable */
//Sat Aug 01 2020 16:07:03 GMT+0800 (GMT+08:00)
...
export async function get_org_getAll(d?: any) {
    return await request.get<PageModel<OrgVO>, PageModel<OrgVO>>('/system/org/getAll', { params: d })
}
/**查询组织列表*/
...
export async function post_user_add(d?: UserBaseVO) {
    return await request.post<number, number>('/system/user/add', d)
}
/**批量添加用户岗位及角色*/
