 ...
 * @LastEditors: wwq
 * @LastEditTime: 2020-12-11 08:47:07
-->
<template>
          ...
          <template slot-scope="scope">
            ...
            >
              ...
              <el-dropdown-menu slot="dropdown">
                <el-dropdown-item @click.native.prevent="edit(scope)">编辑
                </el-dropdown-item>
                <el-dropdown-item @click.native.prevent="remove(scope)">删除
                </el-dropdown-item>
              </el-dropdown-menu>
            </el-dropdown>
          </template>
...
export default class AchieveScaleSchemeList extends Vue {
  ...
  async getListMixin() {
    ...
    let propertyEnumList = (self as any).$root.dictAllList("Property"); // 物业类型
    ...
    self.resPageInfo = await post_achieveScaleScheme_getList(
