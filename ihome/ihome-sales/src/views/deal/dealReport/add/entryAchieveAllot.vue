 ...
 * @LastEditors: lsj
 * @LastEditTime: 2021-05-14 17:00:32
-->
<template>
  ...
  export default class EntryAchieveAllot extends Vue {
    ...
    * */
    ...
    getPostData() {
      ...
      obj.basic.dealVO.firstContNo = this.postData.firstContNo;
      // 优惠告知书ids
      ...
      // obj.basic.dealVO.reportId = this.baseInfoInDeal.recordId; // 2021-05-08
      obj.basic.dealVO.reportId = this.postData.roomId ? this.postData.reportId : null;
