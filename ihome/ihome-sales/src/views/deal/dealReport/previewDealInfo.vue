        ...
        <el-row>
          ...
          <el-col :span="6">
            <el-form-item label="项目周期">
              <el-input disabled placeholder="项目周期" v-model="postData.contType"/>
            </el-form-item>
          </el-col>
          <el-col :span="6">
          ...
          <el-col :span="6">
            <el-form-item label="合同编号">
              <el-input v-model="postData.contNo" disabled placeholder="合同编号"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
          ...
          <el-col :span="6">
            <el-form-item label="认购价格">
              <el-input v-model="postData.subscribePrice" disabled placeholder="认购价格"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
          ...
          <el-col :span="6">
            <el-form-item label="签约价格">
              <el-input v-model="postData.signPrice" disabled placeholder="签约价格"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="6">
        ...
        <el-row>
          ...
          <el-col :span="8">
            <el-form-item label="建筑面积">
              <el-input v-model="postData.area" disabled placeholder="建筑面积"></el-input>
            </el-form-item>
          </el-col>
          <el-col :span="16">
