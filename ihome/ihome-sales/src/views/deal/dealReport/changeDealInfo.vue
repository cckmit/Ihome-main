 ...
 * @LastEditors: wwq
 * @LastEditTime: 2020-12-11 08:47:28
-->
<template>
    ...
    <div v-if="['baseInfo', 'achieveInfo', 'checkOut'].includes(changeType)">
      ...
      >
        <el-row>
          ...
          <el-col
            :span="6"
            v-if="['baseInfo', 'achieveInfo', 'checkOut'].includes(changeType)"
          >
