<!--
 * @Description: 成交确认有效弹窗
 * @version: 
 * @Author: yag
 * @Date: 2021年2月9日17:40:11
 * @LastEditors: yag
 * @LastEditTime: 2021年2月9日17:40:18
-->
<template>
  <el-dialog
    v-dialogDrag
  ...
  >
    ...
    >
      <el-row>
        <el-col :span="20">
          <el-form-item label="确认成交日期" prop="visitDealTime">
            <el-date-picker
...
@Component({})
export default class ValidDeal extends Vue {
  @Prop() isHandmade!: any;
  @Prop() data!: any;
  ...
  private rules: any = {
    visitDealTime: [
      { required: true, message: "请选择确认成交日期", trigger: "change" },
    ],
  };
