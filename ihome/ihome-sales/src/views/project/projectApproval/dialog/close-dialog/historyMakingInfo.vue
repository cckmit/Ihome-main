 ...
 * @LastEditors: wwq
 * @LastEditTime: 2021-04-27 11:41:10
-->
<template>
  <el-dialog
    v-dialogDrag
...
import {
  get_his_settleCondition_getMakingType__termId,
...
export default class MakingInfo extends Vue {
  ...
  async getMakingType() {
    let obj: any = {};
    obj = await get_his_settleCondition_getMakingType__termId({
  ...
  // 获取结佣详情
  async getMakingInfo() {
    const item = await post_his_settleCondition_getMaking__settleId({
