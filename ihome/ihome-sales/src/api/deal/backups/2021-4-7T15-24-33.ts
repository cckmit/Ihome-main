...
/**定时器测试*/
export async function get_suppDeal_updateNoticDocument (d?: any) {
return await request.get<any,any>(basePath+'/suppDeal/updateNoticDocument', { params: d })
}
/**修改退房*/
...
/**ReceiveAchieve*/
export interface ReceiveAchieve {
/**本单业绩*/
