...
/**POS机终端撤机*/
export async function post_posTerminal_revoke__id (d?: any) {
return await request.post< number,number> (basePath+'/posTerminal/revoke/{id}', d)
}
/**修改POS机终端*/
