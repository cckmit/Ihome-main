...
export async function post_project_getBuildingRoomByPro__proId(d?: any) {
    return await request.post<BuildingRoomVo[], BuildingRoomVo[]>(basePath + '/project/getBuildingRoomByPro/{proId}', d)
}
/**getFuzzySearch*/
