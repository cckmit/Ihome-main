...
/**产生类别(ServiceFeesurplus-服务费盈余、TansactionRefund-成交退款、TransactionChange-成交变更、TransactionSupplement-成交补充、Other-其他)*/
addcategory: string;
